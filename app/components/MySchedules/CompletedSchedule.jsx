...
const CompletedSchedule = () => {
    const data = [
        ...
        {
          "title": "Pilates Session asdkfhjd kjhsdk fhdshfkdjfh kdshfkhk",
  ...
  return (
    <View className="flex w-[98%] mx-auto px-2 flex-col items-center mt-4" style={{gap:10}}>
        ...
        renderItem={({item})=>{
            ...
            return <ScheduleInstance title={item.title} date={formattedDate} time={formattedTime} link={item.link} trainer={item.trainer} isCompleted={true}
            />}}
