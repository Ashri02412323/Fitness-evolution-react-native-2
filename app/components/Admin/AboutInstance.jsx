...
const AboutInstance = ({title,value}) => {
  return (
    <View className="flex flex-row h-[38px]">
      <View className="w-[90px] mr-6 relative h-full flex justify-center">
      ...
      <Text className={`${value?"text-white_87":"text-white_60"} font-inter_Regular text-base py-2 h-full `}>
        {value ?? "Not Defined"}
      </Text>
    </View>
  )
