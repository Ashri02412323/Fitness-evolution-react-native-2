...
const baseUrl = 'http://192.168.1.12:3000/v0/api/user';

const uploadImg = async (imageUri) => {
  const url = `http://192.168.1.12:3000/v0/api/images/uploadProfile`;
...
export { LoginUser, SignUpUser, VerifyEmail, validateEmail, validatePassword,validateFullName, setNewPass, getToken, logoutUser, checkIfLoggedIn,allUsersUnderTrainer,updateUser };