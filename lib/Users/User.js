...
const baseUrl = 'http://fitnessevolution-env.eba-5itjpppf.us-east-1.elasticbeanstalk.com/v0/api/user';

const uploadImg = async (imageUri) => {
  const url = `http://fitnessevolution-env.eba-5itjpppf.us-east-1.elasticbeanstalk.com/v0/api/images/uploadProfile`;
