...
const baseUrl = 'http://fitnessevol-env.eba-uunkm3cu.us-east-1.elasticbeanstalk.com/v0/api/schedule';
...
// Format date in 24/07/2023 format
    ...
    const deleteSchedule = async (id) => {
        const url = `${baseUrl}/deleteSchedule/${id}`;
        try {
    ...
    export {formatDate, formatTime, fetchUpcoming, fetchCompleted, fetchRequested, markAsCompleted, postSchedule, modifySchedule,fetchUserUpcoming, fetchUserCompleted, fetchUserRequested,formatDate2,fetchPending,deleteSchedule};